...
chassis.moveToPoint(12, 39.70, 1000,{.forwards = true, .maxSpeed = 70, .minSpeed = 2, .earlyExitRange = 0});
...
chassis.moveToPoint(33.02, -0.01, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed = 1, .earlyExitRange = 0}); // Point 6
chassis.turnToHeading(0, 650);
chassis.moveToPoint(32.7012, 17.99, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed = 0}); // Point 7
pros::Task([] {
	pros::delay(800);
...
chassis.moveToPoint(33.62, 5, 2000, {.forwards = false, .maxSpeed = 127, .minSpeed = 0}); // Point 8
chassis.turnToHeading(180, 700, {.direction = AngularDirection::CCW_COUNTERCLOCKWISE, .maxSpeed = 100}); // Turn to 180 degrees
loaderPiston.set_value(true); // Loader piston down
chassis.moveToPoint(33.07, -12.86, 1000, {.forwards = true, .maxSpeed = 127, .minSpeed = 0}); // Point 8
// chassis.moveToPoint(39.92, 18.67, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed = 0}); // Point 9
pros::delay(1050);
chassis.moveToPoint(32.6002, 5, 1000, {.forwards = false, .maxSpeed = 127, .minSpeed = 0}); // Point 10
chassis.turnToHeading(0, 700, {.direction = AngularDirection::CW_CLOCKWISE, .maxSpeed = 100});
chassis.moveToPoint(32.60012, 18.07, 1000, {.forwards = true, .maxSpeed = 127, .minSpeed = 0}); // Point 7
pros::Task([] {
	loaderPiston.set_value(false); // Loader piston up
	pros::delay(100);
	trapdoorPiston.set_value(true); // Trapdoor piston up
