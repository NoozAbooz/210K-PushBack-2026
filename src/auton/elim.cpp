...
chassis.moveToPoint(12.0, 36.02, 4000, {.forwards = true, .maxSpeed = 47, .minSpeed = 40}); // Point 2
//chassis.moveToPoint(12, 39.90, 1000,{.forwards = true, .maxSpeed = 70, .minSpeed = 2, .earlyExitRange = 0});
chassis.turnToHeading(90, 750); // Turn to 90 degrees
chassis.moveToPoint(26.8, 42.5, 2000, {.forwards = true, .maxSpeed = 80, .minSpeed = 2}); // Point 3
pros::Task([] {
	pros::delay(180);
...
chassis.moveToPoint(31.3012, 16.99, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed = 0}); // Point 7
pros::Task([] {
	pros::delay(800);
...
chassis.moveToPoint(31.10012, 17.07, 1000, {.forwards = true, .maxSpeed = 127, .minSpeed = 0}); // Point 7
...
//chassis.moveToPoint(-12, 39.90, 1000,{.forwards = true, .maxSpeed = 70, .minSpeed = 2, .earlyExitRange = 0});
chassis.turnToHeading(270, 750); // Turn to 90 degrees
chassis.moveToPoint(-26.8, 42.5, 2000, {.forwards = true, .maxSpeed = 80, .minSpeed = 2}); // Point 3
pros::Task([] {
	pros::delay(180);
	loaderPiston.set_value(true); // Loader piston down
