...
void skills(){
    // libKW MTPoint v0.1
// Starting point: (-43.81 in, 13.17 in)
 kw::moveToPoint(0.00, 0.00, 2000); // Start Same as Left Elims
 kw::moveToPoint(-5.58, 21.16, 2000 ); // Move To Four Stack
 kw::moveToPoint(-1.68, 34.31, 2000, false); // mid goal
 //Intake mid here
 kw::moveToPoint(-31.86, -1.84, 2000 ); // loader movement
 kw::moveToPoint(-31.86, -14.71, 2000 ); // loading
 kw::moveToPoint(-45.96, 23.29, 2000 ); // boomerang to alley
