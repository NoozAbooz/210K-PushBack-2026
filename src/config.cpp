...
double kw::horizontal_tracker_dist_from_center = 1.1; // must change to 3.44, the actual offset
double kw::horizontal_tracker_diameter = 2; // Diameter of the horizontal tracker wheel (in inches)
